...
class Classifier:
    ...
    @staticmethod
    def train_mnist(model, save=True, epochs=10, batch_size=32, verbose=1):
        ...
        if save:
            model.save('./keras_piro.h5')

        return model

    @staticmethod
    def train_piro(model, save=True, epochs=10, batch_size=32, verbose=1):
